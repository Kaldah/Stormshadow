...
class AttackPanel:
    ...
    def _create_attack_selection(self):
        ...
        # Attack description
        self.description_label = ttk.Label(selection_frame, text="Select an attack module to see details.",
                                          wraplength=400)
    ...
    def _create_target_configuration(self):
        ...
        self.target_port_entry = ttk.Entry(target_frame, textvariable=self.target_port_var, width=10)
        ...
        ttk.Button(quick_frame, text="Local Lab", 
    ...
    def _create_status_display(self):
        ...
        self._add_status_message("Ready to launch attacks. Select an attack module and configure targets.")
    
    def _on_attack_selected(self, event=None):
        ...
        description = descriptions.get(selected_attack, "No description available for this attack module.")
    ...
    def _start_attack(self):
        ...
        if success:
            ...
            if success:
                ...
                from gui.utils.startup_checks import show_sudo_restart_dialog
                from gui.utils.sudo_utils import restart_with_sudo
                
                self._add_status_message("Attack failed due to permission error!")
                
                if show_sudo_restart_dialog():
                    ...
                    try:
                        ...
                        messagebox.showerror("Restart Failed", f"Could not restart with administrator privileges: {e}")
                else:
