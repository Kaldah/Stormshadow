...
class LabPanel:
    ...
    def _create_lab_configuration(self):
        ...
        ttk.Label(container_frame, text="Container Details:", style="Heading.TLabel").pack(anchor=tk.W)
    ...
    def _create_status_display(self):
        ...
        self._add_status_message("Lab environment ready to start. Configure settings and click 'Start Lab'.")
    ...
    def _start_lab(self):
        ...
        if success:
            ...
            if success:
                ...
                messagebox.showerror("Error", "Failed to start the lab. Check Docker installation and permissions.")
        else:
