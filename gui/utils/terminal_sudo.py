...
def run_sudo_commands_in_terminal(commands: List[str], 
                                ...
                                wait: bool = False) -> subprocess.Popen:
    """
...
def run_docker_lab_in_terminal(docker_command: str, container_name: str = "sip-victim") -> subprocess.Popen:
    """
    ...
    commands = [
        ...
        f'echo "Press Ctrl+C to stop the container"',
        'echo',
        docker_command
    ]
