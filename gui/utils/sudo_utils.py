...
def restart_with_sudo(open_new_terminal: bool = False) -> None:
    ...
    try:
        ...
        if open_new_terminal:
            ...
            print_info("Started new instance with sudo in new terminal, exiting current instance...")
...
def handle_permission_error(operation_name: str, auto_restart: bool = True, open_new_terminal: bool = False) -> bool:
    """
...
def run_command_with_graphical_sudo(command: List[str], operation_name: str = "network operation") -> subprocess.CompletedProcess[str]:
    """
    ...
    try:
        ...
        try:
            ...
            if "password is required" in str(e) or "authentication is required" in str(e).lower() or e.returncode == 1:
...
def run_with_sudo_check(command: List[str], operation_name: str = "network operation") -> subprocess.CompletedProcess[str]:
    """
